...
val GitHubApps = listOf(
    ...
    GitHubApp("org.secuso.aktivpause", "SecUSo", "Aktivpause"),
    ...
    GitHubApp("io.homeassistant.companion.android", "home-assistant", "Android"),
    ...
    GitHubApp("org.futo.inputmethod.latin", "futo-org", "android-keyboard"),
    ...
    GitHubApp("com.onekey.updater.ci", "rumboalla", "apkupdater"),
    ...
    GitHubApp("com.tomclaw.appsend", "solkin", "appteka-android"),
    ...
    GitHubApp("org.breezyweather", "breezy-weather", "breezy-weather", contains("freenet")),
    GitHubApp("org.bromite.bromite", "bromite", "bromite"),
    ...
    GitHubApp("com.kgurgul.cpuinfo", "kamgurgul", "cpu-info"),
    ...
    GitHubApp("org.jak_linux.dns66", "julian-klode", "dns66"),
    ...
    GitHubApp("dev.spiegl.flyingcarpet", "spieglt", "FlyingCarpet"),
    ...
    GitHubApp("com.dergoogler.mmrl", "MMRLApp", "MMRL"),
    ...
    GitHubApp("com.chesire.nekome", "Chesire", "Nekome"),
    ...
    GitHubApp("app.olauncher", "tanujnotes", "Olauncher", notContains("Olauncher-L-")),
    GitHubApp("it.feio.android.omninotes", "federicoiosue", "Omni-Notes"),
    GitHubApp("com.mkulesh.onpc", "mkulesh", "onpc"),
    ...
    GitHubApp("dnsfilter.android", "IngoZenz", "personaldnsfilter"),
    GitHubApp("com.perol.play.pixez", "Notsfsssf", "pixez-flutter"),
    GitHubApp("com.fexed.spacecadetpinball", "fexed", "Pinball-on-Android"),
    ...
    GitHubApp("org.secuso.privacyfriendlyboardgameclock", "SecUSo", "privacy-friendly-boardgame-clock"),
    GitHubApp("org.secuso.privacyfriendlycircuittraining", "SecUSo", "privacy-friendly-circuit-training-exercises"),
    GitHubApp("org.secuso.privacyfriendlydame", "SecUSo", "privacy-friendly-dame"),
    GitHubApp("org.secuso.privacyfriendlyyahtzeedicer", "SecUSo", "privacy-friendly-dice-game"),
    GitHubApp("org.secuso.privacyfriendlydicer", "SecUSo", "privacy-friendly-dicer"),
    GitHubApp("org.secuso.privacyfriendlyfinancemanager", "SecUSo", "privacy-friendly-finance-manager"),
    GitHubApp("org.secuso.privacyfriendlyfoodtracker", "SecUSo", "privacy-friendly-food-tracker"),
    GitHubApp("org.secuso.privacyfriendlyintervaltimer", "SecUSo", "privacy-friendly-interval-timer"),
    GitHubApp("org.secuso.privacyfriendlyludo", "SecUSo", "privacy-friendly-ludo"),
    GitHubApp("org.secuso.privacyfriendlymemory", "SecUSo", "privacy-friendly-memo-game"),
    GitHubApp("org.secuso.privacyfriendlyminesweeper", "SecUSo", "privacy-friendly-minesweeper"),
    GitHubApp("org.secuso.privacyfriendlynotes", "SecUSo", "privacy-friendly-notes"),
    GitHubApp("org.secuso.privacyfriendlypaindiary", "SecUSo", "privacy-friendly-pain-diary"),
    GitHubApp("org.secuso.privacyfriendlypasswordgenerator", "SecUSo", "privacy-friendly-passwordgenerator"),
    GitHubApp("org.secuso.privacyfriendlypausinghealthily", "SecUSo", "privacy-friendly-pausing-healthily"),
    GitHubApp("org.secuso.privacyfriendlyactivitytracker", "SecUSo", "privacy-friendly-pedometer"),
    GitHubApp("org.secuso.privacyfriendlypin", "SecUSo", "privacy-friendly-pin-mnemonic"),
    GitHubApp("com.secuso.privacyFriendlyCodeScanner", "SecUSo", "privacy-friendly-qr-scanner"),
    GitHubApp("org.secuso.privacyfriendlyrecknoningskills", "SecUSo", "privacy-friendly-reckoning-skills"),
    GitHubApp("org.secuso.privacyfriendlyrockpaperscissorsboardgame", "SecUSo", "privacy-friendly-rock-paper-scissors-boardgame"),
    GitHubApp("org.secuso.privacyfriendlyrulerapp", "SecUSo", "privacy-friendly-ruler"),
    GitHubApp("privacyfriendlyshoppinglist.secuso.org.privacyfriendlyshoppinglist", "SecUSo", "privacy-friendly-shopping-list"),
    GitHubApp("org.secuso.privacyfriendlysketching", "SecUSo", "privacy-friendly-sketching"),
    GitHubApp("org.secuso.privacyfriendlysolitaire", "SecUSo", "privacy-friendly-solitaire"),
    GitHubApp("org.secuso.privacyfriendlysudoku", "SecUSo", "privacy-friendly-sudoku"),
    GitHubApp("org.secuso.privacyfriendlytapemeasure", "SecUSo", "privacy-friendly-tape-measure"),
    GitHubApp("org.secuso.privacyfriendlytodolist", "SecUSo", "privacy-friendly-todo-list"),
    GitHubApp("org.secuso.privacyfriendlyweather", "SecUSo", "privacy-friendly-weather"),
    GitHubApp("org.secuso.privacyfriendlycardgameone", "SecUSo", "privacy-friendly-werewolf"),
    ...
    GitHubApp("com.moez.QKSMS", "moezbhatti", "qksms"),
    ...
    GitHubApp("dev.octoshrimpy.quik", "octoshrimpy", "quik"),
    ...
    GitHubApp("com.pavelrekun.rekado", "MenosGrante", "Rekado"),
    GitHubApp("com.bnyro.recorder", "you-apps", "RecordYou"),
    GitHubApp("com.cgutman.androidremotedebugger", "cgutman", "RemoteAdbShell"),
    GitHubApp("com.iiordanov.freebVNC", "iiordanov", "remote-desktop-clients", contains("freebVNC")),
    GitHubApp("com.iiordanov.freeaRDP", "iiordanov", "remote-desktop-clients", contains("freeaRDP")),
    GitHubApp("org.quantumbadger.redreader", "QuantumBadger", "RedReader"),
    ...
    GitHubApp("org.andstatus.todoagenda", "andstatus", "todoagenda"),
    ...
    GitHubApp("juloo.keyboard2", "Julow", "Unexpected-Keyboard"),
    ...
    GitHubApp("is.xyz.vcmi", "vcmi", "vcmi"),
    GitHubApp("org.fsociety.vernet", "osociety", "vernet"),
    ...
    GitHubApp("com.bnyro.wallpaper", "you-apps", "WallYou"),
    GitHubApp("com.aircoookie.WLED", "Aircoookie", "WLED-App"),
    ...
    GitHubApp("us.materialio.app", "Materialious", "Materialious")
)
